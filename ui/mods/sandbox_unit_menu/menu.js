define([], function() {
  return [
    { donation: 1, code: 'A1', build: [
      [10, "/pa/units/land/bot_bomb/bot_bomb.json"],
    ]},
    ...
    { donation: 3, code: 'B1', build: [
      [5, "/pa/units/land/tank_hover/tank_hover.json"],
    ]},
